...
import type { Officer } from "@/interfaces";
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">{officer.ho_ten}</h1>
            <p className="text-gray-600 mt-1">
              {officer.chuc_vu} - {officer.department}
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-2">
          <Button
            variant="outline"
            onClick={() => navigate(`/officers/${officer.id}/relatives`)}
          >
            <Users className="mr-2 h-4 w-4" />
            Quản lý thân nhân ({relativesCount})
          </Button>
          <Button onClick={() => navigate(`/officers?edit=${officer.id}`)}>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-lg font-medium">{officer.ho_ten}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-500">
                    Chức vụ
                  </label>
                  <p className="text-lg">{officer.chuc_vu}</p>
                </div>
              </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm">
                    {new Date(officer.createdAt).toLocaleDateString("vi-VN")}
                  </p>
                </div>
              </div>
            </CardContent>
